...
<body>
  ...
  <?php
    include('nav.php');
    $db = new SQLite3('/db/db3.sqlite');
  ?>

  <!-- Page Content -->
  <div class="container">
    <div class="mb-2 text-center">
      <h1 class="mt-4">Level 3</h1>
    </div>

    <div class="mb-2">
      <p>Est-il possible de contourner le méchanisme d'insécurité suivant? Le flag est dans une autre table cette fois!</p>
      <p><a href="/level3.php?source=1">Cliquez ici pour voir la source</a></p>
    </div>
